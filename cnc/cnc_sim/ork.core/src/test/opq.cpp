...
TEST(opq_serialized_ops)
{
	...
	for( int i=0; i<16; i++ )
	{
		...
		atomic_counter l0ctr, l1ctr, l2ctr, l3ctr;
    	...
    	auto l0_op = [&]()
		{
			...
			int this_l0cnt = l0ctr.fetch_and_increment();
		...
		int this_l0cnt = l0ctr.get();
		int this_l1cnt = l1ctr.get();
